...
SRC=ft_strlen.c ft_memset.c	ft_memmove.c  ft_isprint.c ft_strrchr.c ft_strchr.c ft_memcpy.c ft_bzero.c ft_isalnum.c ft_isdigit.c ft_isalpha.c ft_isupper.c ft_islower.c \
	...
	ft_putnbr_fd.c ft_strdup.c ft_substr.c ft_calloc.c \
	 ft_putendl_fd.c ft_lltoa.c  ft_lltoa_base.c ft_strequ.c ft_strnew.c ft_strdel.c ft_strnequ.c ft_strcount.c ft_dlstnew.c ft_dlstpush.c ft_dlstelemnew.c  ft_dlremovenode.c ft_dlstfind.c ft_dlstexist.c ft_isfile.c ft_path.c
